...
def unet_plus_plus(input_size=(256, 256, 3), base_filter_num=64):
    ...
    up1_0 = Conv2DTranspose(base_filter_num, (2, 2), strides=(2, 2), padding="same")(
        conv1_0
    )
    ...
    up2_0 = Conv2DTranspose(
        base_filter_num * 2, (2, 2), strides=(2, 2), padding="same"
    )(conv2_0)
    ...
    up1_1 = Conv2DTranspose(base_filter_num, (2, 2), strides=(2, 2), padding="same")(
        conv1_1
    )
    ...
    up3_0 = Conv2DTranspose(
        base_filter_num * 4, (2, 2), strides=(2, 2), padding="same"
    )(conv3_0)
    ...
    up1_2 = Conv2DTranspose(base_filter_num, (2, 2), strides=(2, 2), padding="same")(
        conv1_2
    )
    ...
    up4_0 = Conv2DTranspose(
        base_filter_num * 8, (2, 2), strides=(2, 2), padding="same"
    )(conv4_0)
    ...
    up1_3 = Conv2DTranspose(base_filter_num, (2, 2), strides=(2, 2), padding="same")(
        conv1_3
    )
...
def cnn_11(input_size=(256, 256, 3)):
    ...
    model.add(
        Conv2D(64, (3, 3), activation="relu", padding="same", input_shape=input_size)
    )
    model.add(Conv2D(64, (3, 3), activation="relu", padding="same"))
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
